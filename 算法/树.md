...
二叉排序树理想情况下的高度为：$\lceil \log_2{(n+1)}\rceil$
...
平衡二叉树第h层**最少**结点数的递推公式：$N_h=N_{h-1}+N_{h-2}+1$，其中$N_1=1,N_2=2$。
...
具体可参考秒懂百科下的这个视频，可谓是非常直观了：[怎么画出哈夫曼树](https://jingyan.baidu.com/article/380abd0a717c061d90192ca2.html)

以及文章[哈夫曼树的建立、编码以及WPL值的计算](https://blog.csdn.net/sspumyl/article/details/53467604)
